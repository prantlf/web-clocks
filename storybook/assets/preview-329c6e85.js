import{s as E}from"./index-d475d2ea.js";import{d as M}from"./index-bdebfb6d.js";const{logger:_}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var p="backgrounds",{document:s,window:x}=E,B=()=>x.matchMedia("(prefers-reduced-motion: reduce)").matches,S=(r,e=[],n)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===n);if(t)return t.value;if(n){let a=e.map(i=>i.name).join(", ");_.warn(M`
...
//# sourceMappingURL=preview-329c6e85.js.map
